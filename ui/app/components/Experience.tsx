            ...
            >
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <span className={`px-3 py-1 text-xs font-bold uppercase tracking-widest border rounded ${getBadgeColor(exp.badge)}`}>
                      {exp.badge}
                    </span>
                    <div>
              ...
              <div className="px-6 py-3 border-t border-gray-800 bg-gray-800 bg-opacity-30">
                <div className="flex flex-col gap-2 text-xs text-gray-400">
                  <div>
                    <span className="text-gray-500">Duration:</span> {exp.duration}
                  </div>
                  <div>
                    <span className="text-gray-500">Stack:</span> {exp.stack.join(' · ')}
                  </div>
                </div>
              </div>
